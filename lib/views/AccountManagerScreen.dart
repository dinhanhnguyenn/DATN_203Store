...
class _AccountManagerScreenState extends State<AccountManagerScreen> {
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      IconButton(
                                        onPressed: () {   
                                          User del = User(
                                            user_id: accountListByAdmin[index]["user_id"], 
                                            full_name: "", 
                                            password: "", 
                                            username: "", 
                                            status: ""
  ...
  Future<List> loadAccountByAdmin() async {
    final response = await http.get(Uri.parse('http://192.168.1.6/flutter/loadAccount.php'));
  ...
  Future userDelete(User pro) async {
    final uri = Uri.parse('http://192.168.1.6/flutter/deleteAccount.php');
