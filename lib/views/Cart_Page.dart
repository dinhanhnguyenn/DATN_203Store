...
class _CartState extends State<Cart> {
  ...
  Future<void> _fetchCartItems() async {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.30.35/flutter/loadDetail_Cart.php'),
  ...
  Future<void> _deleteItemCart(String cartDetailId) async {
    final response = await http.post(
      Uri.parse('http://192.168.30.35/flutter/update_status.php'),
  ...
  Future<void> _updateQuantity(String cartDetailId, int newQuantity) async {
    final response = await http.post(
      Uri.parse('http://192.168.30.35/flutter/update_quantity.php'),
      body: {
                ...
                return Card(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Image.network(
                          'http://192.168.30.35/flutter/uploads/${item['image']}',
                          width: 50,
                          height: 50,
                          fit: BoxFit.cover,
                        ),
