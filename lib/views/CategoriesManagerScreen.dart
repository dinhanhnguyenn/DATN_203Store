                                        ...
                                        IconButton(
                                          onPressed: () {  
                                            Category del = Category(
                                              category_id: categoryListByAdmin[index]["category_id"],
                                              category_name: "",
                                              status: ""
                                            );
                                            categoryDelete(del);                
                                        ...
                                        IconButton(
                                          onPressed: () {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => UpdateCategoriesScreen(categories: categoryListByAdmin[index]),
                                              ),
                                            );
                                          },
...
Future<List> loadCategoriesByAdmin() async {
  final response = await http.get(Uri.parse('http://192.168.1.3/flutter/loadCategoriesByAdmin.php'));
...
Future categoryDelete(Category pro) async {
  final uri = Uri.parse('http://192.168.1.3/flutter/deleteCategories.php');
